        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          >
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-xl border border-white/15 text-xs font-semibold text-stone-200 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
              ...
              <span className="tracking-wide text-stone-100">Online Christian Supplementary School</span>
            ...
            <p className="text-stone-300 text-base sm:text-lg max-w-2xl font-sans-body leading-relaxed mx-auto lg:mx-0 font-normal">
              Transform your child’s academic confidence with structured, faith-rooted mastery. We provide rigorous small-group tuition in <strong className="text-white font-semibold">Maths, English, and Science</strong> (KS1–KS4), bespoke development roadmaps, and targeted <strong className="text-[#D4AF37] font-semibold">Year 10 Early Intervention</strong> to secure peak GCSE outcomes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1 text-left max-w-xl mx-auto lg:mx-0">
              <div className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 text-xs sm:text-[13px] text-stone-200">
                ...
                <span>Christian worldview & character formation</span>
              </div>
              <div className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 text-xs sm:text-[13px] text-stone-200">
                <CheckCircle2 className="w-4 h-4 text-[#D4AF37] shrink-0" />
                <span>Strictly capped cohorts (max 6 students)</span>
              </div>
              <div className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 text-xs sm:text-[13px] text-stone-200">
                <CheckCircle2 className="w-4 h-4 text-[#D4AF37] shrink-0" />
              ...
              <div className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-white/5 backdrop-blur-md border border-white/10 text-xs sm:text-[13px] text-stone-200">
                <CheckCircle2 className="w-4 h-4 text-[#D4AF37] shrink-0" />
                <span>Active parental partnership & progress reports</span>
              </div>
            </div>
            ...
            <div className="pt-3 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-3.5">
              ...
              >
                <span>Year 10 Strategic Plan</span>
